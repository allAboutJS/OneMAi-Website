...
export const REGIONS: Record<Region, RegionData> = {
	EU: {
		...
		heroTitle: "Group Power. Personal Gains",
		heroSubtitle:
			"OneMAI is the coordination infrastructure behind community savings. We automate trust, contributions, and payouts for the groups that banks never served, Globally.",
		faqHeroTitle: "Frequently Asked Questions (Europe)",
		faqHeroSubtitle:
			"Managing community finance securely in the European landscape.",
		faqs: [
			{
				id: "eu-1",
				question: "How is OneMAI helpful for expats in Europe?",
				answer:
					"OneMAI provides a structured way for expats to build financial resilience through community support, mirroring trusted informal practices with modern legal and technical safeguards.",
			},
			{
				id: "eu-2",
				question: "Is community financing legal in Europe?",
				answer:
					"Yes, OneMAI works with regulated financial partners to ensure all transactions are compliant with European financial regulations.",
			},
			{
				id: "eu-3",
				question: "Are there any fees for using OneMAI?",
				answer:
					"OneMAI charges a small, transparent platform fee to cover security, processing, and maintenance. There are no hidden interest rates.",
			},
			{
				id: "eu-4",
				question: "Is my personal data protected?",
				answer:
					"Absolutely. We are fully GDPR compliant. Your data is encrypted and used solely for providing our services and ensuring platform security.",
			},
		],
		howItWorks: {
			heroTitle: "How OneMAI Works",
			heroSubtitle:
				"Step-by-step to group savings, transparent coordination, and secure payouts in Europe.",
		...
		benefits: {
			heroTitle: "Benefits",
			heroSubtitle:
				"Unlock collective financial power and build a stronger future with OneMAI in Europe.",
			...
			orgBenefits: {
				...
				items: [
					...
					},
					{
						...
						text: "Access detailed reports on financial wellness programs.",
					},
				],
			},
			safetyPoints: [
		...
		about: {
			...
			valuesList: [
				...
				{
					label: "Innovation",
					text: "modern solutions for timeless practices",
				},
			],
			ctaTitle: "Join Us",
			ctaText:
		...
		home: {
			...
			howItWorksSteps: [
				...
				},
				{
					...
					description:
						"Begin contributing and receiving payouts in line with your community’s established rules. You can also request a position change from a member of your pod.",
					points: [
						"Activate your pod when members are complete.",
						"Contribute to Pod",
						"Receive your payout",
					],
				},
		...
		footerOperatorInfo:
			"Operated by Cortejo Magnata Lda\nNIF: 518842016.\nRegistered in Portugal.",
	...
	NG: {
		...
		ctaText:
			"Bring your Ajo group online and experience the ease of automated coordination and secure payouts.",
		domain: ".ng",
		name: "Nigeria",
		contactEmail: "hello@joinonemai.com",
		...
		socialLinks: {
			...
			instagram:
				"https://www.instagram.com/onemai.ng/?fbclid=IwY2xjawQBMNpleHRuA2FlbQIxMQBzcnRjBmFwcF9pZAEwAAEeNT2KDP7M_Byhumj349Kt_aUnnocBoj3CXBCIT0e60D8chS9mmn_moKm-2sY_aem_pntEB98VXF643-5WciffkQ",
		...
		faqHeroSubtitle:
			"Modernizing Ajo and Esusu with security and transparency.",
		faqs: [
			{
				id: "general-1",
				question: "What is OneMAI?",
				answer:
					"OneMAI is a digital platform that helps people organise money together in a simple and trusted way. It is built for people who save, contribute or support each other as a group, like ajo, esusu, thrift, but with better structure and visibility .",
			},
			{
				id: "general-2",
				question: "How do I get started?",
				answer:
					"Simply sign up on the OneMAI website, verify your details, create a group or join one with an invite, agree on how much and when to contribute, start contributing and tracking payments. We offer a guided tour to help you get acquainted.",
			},
			{
				id: "general-3",
				question: "Is there a free trial?",
				answer:
					"Yes, your first payout is completely free so you can experience the platform before committing.",
			},
			{
				id: "general-4",
				question: "How can I contact support?",
				answer:
					"You can reach our support team via the contact page or by emailing hello@joinonemai.com.",
			},
			{
				id: "ng-money-hold",
				question: "Does OneMAI hold my money?",
				answer:
					"Funds contributed through OneMAI are held by regulated financial partners (CBN-licensed financial institutions where applicable). OneMAI does not take deposits or custody customer funds; it simply provides the rules and workflow that trigger releases via those regulated partners, in compliance with CBN frameworks.",
			},
			{
				id: "ng-payment-fail",
			...
			},
			{
				...
				answer:
					"Just tap “forgot password” on the login screen and follow the steps to reset it using your phone number or email and you’ll be back into your account in few minutes.",
			},
			{
				id: "ng-multi-group",
				question: "Can I belong to more than one Pod ?",
				answer:
					"Yes, you can join or create multiple Pods at the same time and track each one seperately on OneMAI.",
			},
		],
		howItWorks: {
			heroTitle: "How OneMAI Works",
			...
			responsibilities: {
				...
				items: ["Admins: create Pod.", "Members: maintain community trust."],
			},
			disputes: {
		...
		benefits: {
			...
			heroSubtitle:
				"Harness the power of community to build wealth and financial security.",
			sectionTitle: "A Trusted Tradition Strengthened by Technology",
			userBenefits: {
				title: "For Individuals & Groups",
				items: [
					{
						title: "Access to Zero-interest Capital",
						text: "Get access to bulk funds for business or personal needs without the burden of high interest rates.",
					},
					{
						title: 'Eliminate "Runaway" Risks',
						text: "Every contribution is tracked and payouts are automated, ensuring maximum security for your Pods.",
					},
					{
						title: "Build Your Credit Profile",
						text: "Formalize your informal savings history to unlock better financial opportunities in the future.",
					},
					{
						title: "Community Financial Safety Net",
						text: "A trusted environment where members support each other to reach financial milestones.",
					},
				],
			},
			orgBenefits: {
				...
				items: [
					{
						title: "Automated Cooperative Management",
						text: "Digitalize your cooperative society or staff thrift group for better efficiency and less paperwork.",
					},
					{
						title: "Employee Financial Stability",
						text: "Help your staff manage their finances better through structured group savings.",
					},
					{
						title: "Reduced Administrative Stress",
						text: "Focus on growth while our platform handles collection and payout schedules.",
					},
					{
						title: "Transparent Record Keeping",
						text: "Real-time dashboards for all contributions and payout cycles.",
					},
				],
			},
			safetyPoints: [
		...
		about: {
			...
			missionTitle: "Our Mission",
			missionText:
				"To modernize community finance through transparent, community-powered coordination built on trust and accessibility.",
			valuesTitle: "Our Values",
			valuesList: [
				{ label: "Integrity", text: "honoring every contribution" },
				{
					label: "Transparency",
					text: "real-time visibility for every member",
				},
				{
					label: "Community",
					text: "strengthening the bonds that build wealth",
				},
				{ label: "Security", text: "protecting group funds with technology" },
				{
					label: "Prosperity",
					text: "helping every member of a community reach their goals",
				},
			],
			ctaTitle: "Start Your Pod",
			ctaText:
				"Bring your community online and experience the ease of automated coordination for contribution and secure payouts.",
		},
		home: {
			howItWorksSubtitle: "it's that simple",
			howItWorksSteps: [
				{
					...
					description:
						"Start by creating your own Pod or joining an existing one. Connect with like-minded individuals who share your financial goals.",
		...
		faqs: [
			{
				...
				question: "What is OneMAI?",
				answer:
					"OneMAI is a global platform for community-powered financial coordination, making collective saving and financing safe and accessible for everyone.",
			},
			{
				id: "global-2",
				question: "How do I create a new circle?",
				answer:
					'Once you sign up, simply click on "Start a Circle," define your payout order, contribution amounts, and invite your trusted community members.',
			},
			{
				id: "global-3",
				question: "Who can I invite to my circle?",
				answer:
					"You can invite anyone you trust. OneMAI is built on community trust, so it works best with friends, family, or professional networks.",
			},
		],
		howItWorks: {
			heroTitle: "How OneMAI Works",
