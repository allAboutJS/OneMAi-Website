  ...
  return (
    <main className="">
      <section className="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
        <h1 className="text-4xl font-normal text-gray-900 mb-6">Cookie Policy</h1>
        ...
        <h2 className="text-2xl font-normal text-gray-900 mb-4">1. What Are Cookies?</h2>
        ...
        <h2 className="text-2xl font-normal text-gray-900 mb-4">2. Types of Cookies We Use</h2>

        <h3 className="text-xl font-medium text-gray-900 mb-1">Strictly Necessary Cookies</h3>
        ...
        <h3 className="text-xl font-medium text-gray-900 mb-1">Performance and Analytics Cookies</h3>
        ...
        <h3 className="text-xl font-medium text-gray-900 mb-1">Functional and Preference Cookies</h3>
        ...
        <h2 className="text-2xl font-normal text-gray-900 mb-4">3. Third-Party Tools and Services</h2>
        <p className="text-lg text-gray-700 mb-8">
        ...
        <h2 className="text-2xl font-normal text-gray-900 mb-4">4. Your Choices and Control</h2>
        ...
        <h2 className="text-2xl font-normal text-gray-900 mb-4">5. Updates to This Cookie Policy</h2>
        ...
        <h2 className="text-2xl font-normal text-gray-900 mb-4">Cookie and Privacy Questions</h2>
