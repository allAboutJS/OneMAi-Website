            ...
            <section className="relative min-h-[40vh] md:min-h-[50vh] flex items-center bg-gray-900">
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-6 py-16 md:py-24 w-full text-white">
                    <div className="max-w-3xl">
                        <h1 className="text-4xl sm:text-5xl md:text-6xl font-normal leading-tight mb-6">
                            {hw.heroTitle}
                        </h1>
            ...
            <section className="max-w-7xl mx-auto px-6 py-14">
                ...
                <div className="grid md:grid-cols-2 gap-8 mt-10">
                    <div className="bg-blue-50 border border-blue-100 rounded-xl p-6">
                        <h4 className="text-lg font-medium mb-2">{hw.responsibilities.title}</h4>
                    ...
                    <div className="bg-green-50 border border-green-100 rounded-xl p-6">
                        <h4 className="text-lg font-medium mb-2">{hw.disputes.title}</h4>
                        <ul className="list-disc pl-5 space-y-2 text-gray-700">
                ...
                <div className="mt-10">
                    <Link
                        to="/faq"
                        className="inline-block px-6 py-3 bg-[#3390D5] text-white rounded-lg font-medium hover:bg-blue-700"
                    >
                        Read FAQs
                    </Link>
                </div>
